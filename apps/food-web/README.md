# apps/food-web — prototype web de Food

> **Prototype.** L'app cible est l'app Android [apps/food/](../food/README.md) (Kotlin/Compose,
> DB embarquée). Ce prototype web garde la même logique et lit le même catalogue
> `apps/food/seed/*.json` ; il sert de banc d'essai des règles (deck, jauge, cuisine).
...
La DB est `data/food/food.db` (vault, non versionnée), créée et remplie depuis `../food/seed/`
...
```bash
npm run food            # ou : python3 apps/food-web/server.py [--port 8714] [--reset]
```
