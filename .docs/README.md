...
- [mac-maintenance.md](mac-maintenance.md) — le Mac : espace disque (`p6 disk`), apps imposées / agents orphelins (`p6 apps`), qui parle à qui sur le réseau (`p6 net`), pistes Pi-hole / LuLu
